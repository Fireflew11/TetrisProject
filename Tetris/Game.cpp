...
void Game::initializePlayers(char pick)
{
    ...
    case MenuOption::PVC:
        players[0] = new Human(gameConfig::PlayerType::LEFT_PLAYER);
        players[1] = new Computer(gameConfig::PlayerType::RIGHT_PLAYER, gameConfig::Difficulty::BEST);
        break;
    case MenuOption::CVC:
        players[0] = new Computer(gameConfig::PlayerType::LEFT_PLAYER, gameConfig::Difficulty::BEST);
        players[1] = new Computer(gameConfig::PlayerType::RIGHT_PLAYER, gameConfig::Difficulty::BEST);
    default:
        break;
    }
